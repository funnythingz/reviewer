  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created clinic" do
        post :create, {:clinic => valid_attributes}, valid_session
        expect(response).to redirect_to(Clinic.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved clinic as @clinic" do
        post :create, {:clinic => invalid_attributes}, valid_session
        expect(assigns(:clinic)).to be_a_new(Clinic)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested clinic" do
        clinic = Clinic.create! valid_attributes
        put :update, {:id => clinic.to_param, :clinic => new_attributes}, valid_session
        clinic.reload
    ...
    describe "with invalid params" do
      it "assigns the clinic as @clinic" do
        clinic = Clinic.create! valid_attributes
        put :update, {:id => clinic.to_param, :clinic => invalid_attributes}, valid_session
        expect(assigns(:clinic)).to eq(clinic)
      end
